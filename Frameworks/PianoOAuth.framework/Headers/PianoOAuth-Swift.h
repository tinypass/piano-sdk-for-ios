...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PianoOAuth",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface BaseOAuthPopupViewController (SWIFT_EXTENSION(PianoOAuth)) <WKNavigationDelegate>
...
@protocol PianoIDDelegate;

SWIFT_CLASS("_TtC10PianoOAuth7PianoID")
@interface PianoID : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) PianoID * _Nonnull shared;)
+ (PianoID * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, weak) id <PianoIDDelegate> _Nullable delegate;
@property (nonatomic, copy) NSString * _Nonnull aid;
...
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
- (void)signIn;
- (void)signOutWithToken:(NSString * _Nonnull)token;
- (BOOL)handleUrl:(NSURL * _Nonnull)url sourceApp:(NSString * _Nullable)sourceApp annotation:(id _Nonnull)annotation SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_PROTOCOL("_TtP10PianoOAuth15PianoIDDelegate_")
@protocol PianoIDDelegate
@optional
- (void)pianoID:(PianoID * _Nonnull)pianoID didSignInForToken:(NSString * _Null_unspecified)token withError:(NSError * _Null_unspecified)error;
- (void)pianoID:(PianoID * _Nonnull)pianoID didSignOutWithToken:(NSString * _Nonnull)token withError:(NSError * _Null_unspecified)error;
- (void)pianoIDSignInDidCancel:(PianoID * _Nonnull)pianoID;
@end

typedef SWIFT_ENUM(NSInteger, PianoIDError, closed) {
  PianoIDErrorInvalidAuthorizationUrl = -1,
  PianoIDErrorCannotGetDeploymentHost = -2,
  PianoIDErrorLogoutFailed = -3,
};
static NSString * _Nonnull const PianoIDErrorDomain = @"PianoOAuth.PianoIDError";


SWIFT_CLASS("_TtC10PianoOAuth31PianoIdOAuthPopupViewController")
@interface PianoIdOAuthPopupViewController : BaseOAuthPopupViewController
...
@protocol PianoOAuthDelegate
- (void)loginSucceededWithAccessToken:(NSString * _Nonnull)accessToken;
- (void)loginCancelled;
@end
