...
+ (NSString * _Nonnull)tinypassEndpointUrl SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull sandboxEndpointUrl;)
+ (NSString * _Nonnull)sandboxEndpointUrl SWIFT_WARN_UNUSED_RESULT;
...
- (PianoComposer * _Nonnull)customVariableWithName:(NSString * _Nonnull)name value:(id _Nonnull)value SWIFT_WARN_UNUSED_RESULT;
- (PianoComposer * _Nonnull)customVariablesWithCustomVariableCollection:(NSDictionary<NSString *, id> * _Nonnull)customVariableCollection SWIFT_WARN_UNUSED_RESULT;
